...
class ODESim(object):
    ...
    def addObj(self):
        ...
        #self.objnodepath.setPos(random.uniform(580, 610), random.uniform(-80, 80), 100.0)
        self.objnodepath.setPos(random.uniform(550, 650), random.uniform(50,100 ), 80.0)
        #self.objnodepath.setPos(random.uniform(600, 650), random.uniform(-200, 200), 100.0)
        #self.objnodepath.setPos(random.uniform(580,620), random.uniform(-10, 10), 50.0)
