...
class ODESim(object):
    ...
    def addObj(self):
        ...
        #self.objnodepath.setPos(670,-25,200)
        # t2tube
        #self.objnodepath.setPos(random.uniform(500, 650), random.uniform(-100, 100), 100.0)
        # planereadway

        #self.objnodepath.setPos(random.uniform(600, 650), random.uniform(-100, 100), 100.0)
        #self.objnodepath.setPos(random.uniform(550, 650), random.uniform(-30, 30), 50.0)
        #self.objnodepath.setPos(random.uniform(600, 650), random.uniform(-200, 200), 100.0)
        self.objnodepath.setPos(random.uniform(540,600), random.uniform(-100, 100), 50.0)
        #self.objnodepath.setPos(600,0, 30.0)


        #test chuan1 mo2
        # mat=Mat4(0.655477 ,0.716269 ,-0.239393 ,0,\
        #                         -0.452043, 0.626041, 0.635398, 0,\
        #                         0.604985 ,-0.308273, 0.734139, 0,\
        #                             575.551, -77.5075 ,100 ,1)
        # self.objnodepath.setMat(mat)
        # self.objnodepath.setPos(575.551, -77.5075, 100)

        self.lasttime0 = self.objnodepath.getPos()
        #self.lasttime0rot = self.objnodepath.getRot()
