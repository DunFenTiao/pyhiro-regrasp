...
from manipulation.regrasp_onworkcell.grip import freegripcontactpairs_air as fgcp_air
...
class Freegrip(fgcp_air.FreegripContactpairs):
...
if __name__=='__main__':
    ...
    #objpath = os.path.join(this#_dir, "objects", "brick.stl")
