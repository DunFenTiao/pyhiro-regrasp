...
class FreegripContactpairs(object):
    ...
    def __init__(self, ompath,idstablepos=1,readser=False):

        self.dbobjname = os.path.splitext(os.path.basename(ompath))[0]
        # load stable times
        self.dbidstablepos=idstablepos
        ...
        if readser is False:
            ...
            self.loadObjModel(ompath,objrotmat,objposmat)
...
if __name__=='__main__':
    ...
    freegriptst = FreegripContactpairs(objpath,1)
